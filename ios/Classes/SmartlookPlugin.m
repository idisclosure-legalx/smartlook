...
- (void)setupSmartlook:(id)flutterOptions {
    ...
    [setupOptions setValue:@NO forKey:SLSetupOptionUseAdaptiveFramerateKey];
    
    id key = [options valueForKey:@"ApiKey"];
    ...
    [setupOptions setValue:@"FLUTTER" forKey:@"__sdk_framework"];
    // @"__sdk_framework_version"
    // @"__sdk_framework_plugin_version"
